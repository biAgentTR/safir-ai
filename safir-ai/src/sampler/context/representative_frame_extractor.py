...
ayri, opsiyonel bir katmandir; zirve karenin oncesinde ve sonrasinda, ayni
`pre_event_sec`/`post_event_sec` zaman penceresi kullanilarak dogrudan
kaynak videodan seek edilen iki ek kare cikarir ve zirve kareyle birlikte
zaman sirali `RepresentativeFrame` listesi olarak dondurur. Ayrica bir
`context.mp4` klibi URETMEZ; VLM'e dogrudan `image_url` bloklari olarak
gonderilecek JPEG+base64 kareler uretir.
"""
