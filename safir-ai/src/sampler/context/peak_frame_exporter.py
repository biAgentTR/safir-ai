"""Her Olay Grubu (event) icin pre_peak/peak/post_peak `.jpg` + `metadata.json` disk cikisi.

`AdaptiveFrameSampler`'in evidence/clustering/peak-secim mantigindan tamamen
ayri, opsiyonel bir katmandir. Video/klip (`.mp4`) URETMEZ; yalnizca zirve
karenin oncesinden/sonrasindan, kaynak videodan dogrudan seek edilen iki ek
kareyi ve zirve karenin kendisini JPEG olarak diske yazar:

    outputs/sampler/event_0001/pre_peak.jpg
    outputs/sampler/event_0001/peak.jpg
    outputs/sampler/event_0001/post_peak.jpg
    outputs/sampler/event_0001/metadata.json
"""
