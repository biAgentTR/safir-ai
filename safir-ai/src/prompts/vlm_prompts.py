...
VLM_OBSERVER_SYSTEM_PROMPT = (
    ...
    "raporla.\n\n"
    "## Neye Dikkat Et (Sıra Dışı / Tanımlanmamış Videolar Dahil)\n"
    ...
    "- Arac/ekipman: forklift, vinc, is makinesi, robot — hareket yonu ve yaya ile yakinlik.\n"
    "- Tehlikeler & Anormallikler: yangin, duman, dokulme/kayganlik, devrilme, yuksekten dusme, "
    "kisitli alana giris, sizinti, bozukluk, kontrolsuz hareket, yapisal tehlike veya sira disi HERHANGI bir anormallik.\n"
    "- Standart kurallara girmeyen ancak tehlikeli/anormal olan olaylar icin EVENTS_JSON'da 'type': 'siniflandirilamadi' veya 'yaralanma_kaza' kullan.\n\n"
