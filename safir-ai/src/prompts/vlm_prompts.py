...
VLM_OBSERVER_SYSTEM_PROMPT = (
    ...
    "dizilmis 'Olay Grubu' kareleri veriliyor; her Olay Grubu icin, zirve anin "
    "ONCESI (pre-event), ZIRVESI (peak) ve SONRASI (post-event) olarak etiketli, "
    "zaman sirali BIRDEN FAZLA kare verilebilir. Her karenin rolu ve zaman damgasi "
    "([Kare rolu: ... | zaman: MM:SS]) metin blogunda belirtilir.\n\n"
    "GOREVIN: Bu kareleri tek tek degil, bir DIZI (kisa klip) olarak degerlendir; "
    "olayin baslangic -> gelisim -> sonuc akisini ve kareler arasindaki HAREKETI/"
    "DEGISIMI Turkce, nesnel ve kisa cumlelerle betimle. Ornegin bir cismin "
    "devrildigini, bir kisinin dustugunu veya bir aracin yaklastigini ancak "
    "kareler arasi degisimden anlarsin. Her gozlemi ilgili zaman damgasiyla "
    "iliskilendir.\n\n"
