...
VLM_OBSERVER_SYSTEM_PROMPT = (
    ...
    "6. **Tetikleyici/Kök Neden Taraması**: Ana tehlikeden ÖNCEKİ kareleri de "
    ...
    "bir vana/valf, kaldırılmış bir bariyer/emniyet ekipmanı gibi KISA VE "
    "KÜÇÜK olabilecek bir eylem/nesne. Bu tür bir an TEK bir karede, hızlı "
    ...
    "et. Net bir tetikleyici GÖRMÜYORSAN UYDURMA - 'gözlemlenmedi/belirsiz' "
    "de; bu KKD/duman/vb. gözlemlerin aksine EK ve OPSİYONEL bir gözlemdir, "
    "her olayda bulunması ZORUNLU DEĞİLDİR.\n\n"
    ...
    "- Olası Tetikleyici/Kök Neden: <varsa, tehlikeye YOL AÇAN gözlemlenen "
    "eylem/nesne ve hangi evidence_id/zamanda görüldüğü; net bir tetikleyici "
    "gözlemlenmediyse 'gözlemlenmedi'>\n"
