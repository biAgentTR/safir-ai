...
_SYSTEM_PROMPT = (
    ...
    "incele. VLM'in baglamdaki '## KRONOLOJI' bolumunu (varsa) her kare "
    "icin dikkate al ve zamansal akisi risk degerlendirmenin merkezine koy; "
    "kare-basi kronolojiyi ozetlemeye veya yeniden yazmaya calisma, muhakemeni "
    "onun uzerine kur. Analizinin sonunda MUTLAKA su formatta bir sonuc "
    "satiri yaz:\n"
...
class SafirAgent:
    ...
    Dugumler:
        reasoning  -> LLM'i (Qwen2.5-Instruct-AWQ/Gemma3) mevcut mesaj gecmisiyle cagirir.
